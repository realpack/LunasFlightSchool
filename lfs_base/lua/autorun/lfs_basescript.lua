...
local DEFAULT_KEYS = {
	["EXIT"]           = { class = "misc",  name_menu = "Exit Vehicle",                     default = KEY_J,        cmd = "cl_lfs_exit",             IN_KEY = 0 },
	["FREELOOK"]       = { class = "misc",  name_menu = "Freelook (Hold)",                  default = MOUSE_MIDDLE, cmd = "cl_lfs_freelook",         IN_KEY = IN_WALK },
	["ENGINE"]         = { class = "misc",  name_menu = "Toggle Engine",                    default = KEY_R,        cmd = "cl_lfs_toggle_engine",    IN_KEY = IN_RELOAD },
	["VSPEC"]          = { class = "misc",  name_menu = "Toggle Vehicle-specific Function", default = KEY_SPACE,    cmd = "cl_lfs_toggle_vspecific", IN_KEY = IN_JUMP },
	["PRI_ATTACK"]     = { class = "misc",  name_menu = "Primary Attack",                   default = MOUSE_LEFT,   cmd = "cl_lfs_primaryattack",    IN_KEY = IN_ATTACK },
	["SEC_ATTACK"]     = { class = "misc",  name_menu = "Secondary Attack",                 default = MOUSE_RIGHT,  cmd = "cl_lfs_secondaryattack",  IN_KEY = IN_ATTACK2 },

	["+THROTTLE"]      = { class = "plane", name_menu = "Throttle Increase",                default = KEY_W,        cmd = "cl_lfs_throttle_inc",     IN_KEY = IN_FORWARD },
	["-THROTTLE"]      = { class = "plane", name_menu = "Throttle Decrease",                default = KEY_S,        cmd = "cl_lfs_throttle_dec",     IN_KEY = IN_BACK },
	["+PITCH"]         = { class = "plane", name_menu = "Pitch Up",                         default = KEY_LSHIFT,   cmd = "cl_lfs_pitch_up",         IN_KEY = IN_SPEED },
	["-PITCH"]         = { class = "plane", name_menu = "Pitch Down",                       default = KEY_LALT,     cmd = "cl_lfs_pitch_Down",       IN_KEY = 0 },
	["-YAW"]           = { class = "plane", name_menu = "Yaw Left",                         default = KEY_Q,        cmd = "cl_lfs_yaw_left",         IN_KEY = 0 },
	["+YAW"]           = { class = "plane", name_menu = "Yaw Right",                        default = KEY_E,        cmd = "cl_lfs_yaw_right",        IN_KEY = 0 },
	["-ROLL"]          = { class = "plane", name_menu = "Roll Left",                        default = KEY_A,        cmd = "cl_lfs_roll_left",        IN_KEY = IN_MOVELEFT },
	["+ROLL"]          = { class = "plane", name_menu = "Roll Right",                       default = KEY_D,        cmd = "cl_lfs_roll_right",       IN_KEY = IN_MOVERIGHT },

	["+THROTTLE_HELI"] = { class = "heli",  name_menu = "Throttle Increase",                default = KEY_W,        cmd = "cl_lfsheli_throttle_inc", IN_KEY = IN_FORWARD },
	["-THROTTLE_HELI"] = { class = "heli",  name_menu = "Throttle Decrease",                default = KEY_S,        cmd = "cl_lfsheli_throttle_dec", IN_KEY = IN_BACK },
	["+PITCH_HELI"]    = { class = "heli",  name_menu = "Pitch Up (Hovermode Only)",        default = KEY_LALT,     cmd = "cl_lfsheli_pitch_up",     IN_KEY = 0 },
	["-PITCH_HELI"]    = { class = "heli",  name_menu = "Pitch Down (Hovermode Only)",      default = KEY_LSHIFT,   cmd = "cl_lfsheli_pitch_Down"    IN_KEY = 0 },
	["-YAW_HELI"]      = { class = "heli",  name_menu = "Yaw Left (Hovermode Only)",        default = KEY_Q,        cmd = "cl_lfsheli_yaw_left",     IN_KEY = 0 },
	["+YAW_HELI"]      = { class = "heli",  name_menu = "Yaw Righ (Hovermode Only)",        default = KEY_E,        cmd = "cl_lfsheli_yaw_right",    IN_KEY = 0 },
	["-ROLL_HELI"]     = { class = "heli",  name_menu = "Roll Left",                        default = KEY_A,        cmd = "cl_lfsheli_roll_left",    IN_KEY = IN_MOVELEFT },
	["+ROLL_HELI"]     = { class = "heli",  name_menu = "Roll Right",                       default = KEY_D,        cmd = "cl_lfsheli_roll_right",   IN_KEY = IN_MOVERIGHT },
	["HOVERMODE"]      = { class = "heli",  name_menu = "Hovermode (Hold)",                 default = KEY_SPACE,    cmd = "cl_lfsheli_hover",        IN_KEY = IN_SPEED },
}
for name, v in pairs( DEFAULT_KEYS ) do
	simfphys.LFS:AddKey( name, v.class, v.name_menu, v.default, v.cmd, v.IN_KEY )
end
